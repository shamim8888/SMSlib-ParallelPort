...
if(UserStudentID())
{
        ...
        {
            case 'day_view':
                DrawHeaderHome('<table width="100%" cellpadding="2" cellspacing="2"><tr><td align="left" width="175" valign="top"><table><tr><td>'.PrepareDateSchedule($date,'_date',false,array('submit'=>true)).'</td><td><INPUT type=submit class=btn_medium value=Go></td></tr></table></td><td align="left">Marking Period :  '.$mp.'</td><td align="right">Calendar View
