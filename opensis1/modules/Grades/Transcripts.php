        ...
        $student_html = '
                <table border="0" style="font-family:Arial; font-size:12px;" cellpadding="0" cellspacing="0"><tr>'.$picturehtml.
                    '<td width=70% valign=bottom>
                        ...
                        </tr></table></td></tr><tr><td colspan="2" style="padding:6px 0px 6px 0px;"><table width="100%" cellspacing="0" cellpadding="3" border="1" align=center  style="font-family:Arial; font-size:13px; border-collapse: collapse; text-align:center"><tr><td><b>Cumulative GPA:</b> '.sprintf("%01.2f",($cgpa_ret[1]['CGPA']) ).'&nbsp;&nbsp;&nbsp;&nbsp;
                            
                                </td></tr><tr><td><b>Total Credit Attempted:</b> '.sprintf("%01.2f",$credit_ret[1]['CREDIT_ATTEMPTED']).'&nbsp;&nbsp;&nbsp;&nbsp;<b>Total Credit Earned:</b> '.sprintf("%01.2f",$credit_ret[1]['CREDIT_EARNED']). '</td></tr></table></td></tr></table>';
