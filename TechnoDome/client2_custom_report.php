...
<?php
...

 {
        ...
        $ships_list_result = pg_exec("select distinct ship_id from money_carrying_view,cargo_schedule where account_id=$clientid and date_part('month',cargo_schedule.departure_date) =$month and date_part('year',cargo_schedule.departure_date)=$year");    ///// selects the number of ships associated with the client
