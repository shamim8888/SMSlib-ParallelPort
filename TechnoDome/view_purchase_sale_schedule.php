...
if ($submitted == 1)
                        ...
                        if ($filling=="viewcheck")
                                {
                                       ...
                                       // echo "alert($dupnumrows...we are in viewcheck and gotocheck $gotocheck)";
                                        $subresult = pg_exec("select * from purchase_sale_schedule order by pur_sale_schedule_id");
        ...
        else
                {
						...
						$query_string = "select * from purchase_sale_schedule order by pur_sale_schedule_id";
...
<?php
	print("opener.location=\"http://technodome.org/purchase_sale_schedule.php?filling=gotobutton&navigation=true&gotocheck=$gotocheck&seenbefore=1\"; ");
 ?>
	window.close();
...
<body onload= "set_attribute()"> <form name = "test" action = "view_purchase_sale_schedule.php" method = "post">
...
$query_string = "select pur_sale_schedule_id,departure_date,ship_name,account_name,from_loc,to_loc,matone_name,mattwo_name,quantity_one,fair_rate,quantity_two,fair_rate_two,advance_tk,part_tk,balance_tk,total_tk,pay_voucher_date,trip_id from pur_sale_schedule_view order by pur_sale_schedule_id LIMIT 24 OFFSET $xz";
...

{
  ...
  $field_name= array('Record','Schd_ID','Dpt.&nbsp;date','&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Ship&nbsp;Name&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;','&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Account&nbsp;Name&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;','&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;From&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;','&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;To&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;','&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Mat_one&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;','&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Mat_two&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;','Qty.One','Fair&nbsp;Rate','Qty.Two','Fair&nbsp;Rate&nbsp;Two','Advance','Part','Balance','Total','Pay&nbsp;Date','Trip&nbsp;ID');
