...
function set_main()
        {
                ...
                <?php
	                print("opener.location=\"http://technodome.org/report.php?year=$year&month=$month&monthname=$monthname\"; ");
                ?>
...
function custom_submit()
        {
             ...
             alert(document.test.year.value);
...
else     ///////////////   Starting condition for selecting ships which have departure date in the selected month


 {


        $ships_list_result = pg_exec("select distinct ship_id from money_carrying_view where account_id=$clientid and date_part('month',departure_date) = $month and date_part('year',departure_date)=$year");    ///// selects the number of ships associated with the client
        ...
        for($ship_count=0;$ship_count<$ships_list_numrows;$ship_count++)    /////////  Executes the loop for each ship
          ...
          {   /////////  Executes the loop for each ship
                        ...
                        $money_trip_result =  pg_exec("select max(trip_id) from money_carrying_view where ship_id=$ships_list[0] and account_id=$clientid ");   //// finds the trip id for for a particular ship
                        ...
                        print ("<div align=\"left\"><b><font size=\"+2\">Ship Name :&nbsp;&nbsp; $SHIPNAME&nbsp;&nbsp; Total trip:$maxtripid</font></b></div>");
                       ...
                       $trip_counter=0;
                        ...
                        for ($trip_counter=1;$trip_counter<=$maxtripid;$trip_counter++)    /////////  execute the loop for a particular ship upto its max trip number

                                {
                                        ...
                                        $moneyresult=pg_exec("select * from money_carrying_view where ship_id= $ships_list[0] and account_id = $clientid and trip_id = $trip_counter ");
