...
public class UnknownMessage extends InboundMessage
{
	...
	public UnknownMessage(String myPdu, int memIndex, String memLocation, String GatewayAddress)
	{
		super(MessageTypes.UNKNOWN, memIndex, memLocation, GatewayAddress);
		this.pdu = myPdu;
	}
