 ...
 */
public class Jmx extends Interface<Integer>
{
	...
	public class SMSServerMethods implements SMSServerMethodsMBean
	{
		...
		public int getInboundMessageCount()
		{
			return this.getInboundMessageCount();
		}
		...
		public int getOutboundMessageCount()
		{
			return this.getOutboundMessageCount();
		}
	}
	...
	/**
	 * Creates this interface and initialize the message spools.
	 * 
	...
	public Jmx(String myInterfaceId, Properties myProps, SMSServer myServer, InterfaceTypes myType)
	{
		...
		setDescription("Default JMX based interface.");
	...
	public void start() throws Exception
	{
		...
		Logger.getInstance().logInfo("Bound JMX to " + url, null, null);
		super.start();
	}
