...
import org.smslib.email.AbstractEmailGateway;
 ...
 */
public class EmailGateway extends AGateway
{
	...
	public void create() throws Exception
	{
		...
		//if (getProperties().getProperty(propName + "secure").equalsIgnoreCase("yes")) ((org.smslib.http.ClickatellHTTPGateway) getGateway()).setSecure((true));
			...
			setGateway(new org.smslib.email.EMAILGateway(getGatewayId(), getProperties().getProperty(propName + "mailbox_protocol"), getProperties().getProperty(propName + "mailbox_host"), getProperties().getProperty(propName + "mailbox_port"),getProperties().getProperty(propName + "mailbox_user"),getProperties().getProperty(propName + "mailbox_password"),getProperties().getProperty(propName + "smtp_host"),getProperties().getProperty(propName + "smtp_port"),getProperties().getProperty(propName + "smtp_user"),getProperties().getProperty(propName + "smtp_password"),getProperties().getProperty(propName + "to"),getProperties().getProperty(propName + "from"), getProperties().getProperty(propName + "message_subject"), getProperties().getProperty(propName + "message_body")));
