 ...
 */
public class ParallelModem extends AGateway
{
	public ParallelModem(String myGatewayId, Properties myProps, org.smslib.smsserver.SMSServer myServer)
	{
		super(myGatewayId, myProps, myServer);
		setDescription("Default Parallel Modem Gateway.");
	}
	...
	public void create() throws Exception
	{
		...
		setGateway(new org.smslib.modem.ParallelModemGateway(getGatewayId(), getProperties().getProperty(propName + "port"), Integer.parseInt(getProperties().getProperty(propName + "baudrate")), getProperties().getProperty(propName + "manufacturer"), getProperties().getProperty(propName + "model")));
		...
		((org.smslib.modem.ParallelModemGateway) getGateway()).setSimPin(getProperties().getProperty(propName + "pin"));
