...
public class StatusReportMessage extends InboundMessage
{
	...
	public StatusReportMessage(SmsStatusReportPdu pdu, int memIndex, String memLocation, String GatewayAddress)
	{
		super(MessageTypes.STATUSREPORT, memIndex, memLocation, GatewayAddress);
	...
	public StatusReportMessage(String myRefNo, int memIndex, String memLocation, String GatewayAddress, Date dateOriginal, Date dateReceived)
	{
		super(MessageTypes.STATUSREPORT, memIndex, memLocation, GatewayAddress);
		this.refNo = myRefNo;
