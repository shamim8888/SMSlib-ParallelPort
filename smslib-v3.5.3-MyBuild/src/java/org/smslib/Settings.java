...
public class Settings
{
	...
	/**
	 * Wait time to give the modem after entering COMMAND mode (milliseconds).
	 */
	...
	public int SERIAL_BUFFER_CHUNK = 0;
        public int PARALLEL_BUFFER_CHUNK = 0;
	public int SERIAL_BUFFER_CHUNK_DELAY = 0;
        public int PARALLEL_BUFFER_CHUNK_DELAY = 0;

	Settings()
	{
		if (System.getProperty("smslib.serial.noflush") != null) this.SERIAL_NOFLUSH = true;
                if (System.getProperty("smslib.serial.noflush") != null) this.PARALLEL_NOFLUSH = true;
		if (System.getProperty("smslib.serial.noevents") != null) this.SERIAL_NOEVENTS = true;
                if (System.getProperty("smslib.serial.noevents") != null) this.PARALLEL_NOEVENTS = true;
		if (System.getProperty("smslib.serial.polling") != null) this.SERIAL_POLLING = true;
                if (System.getProperty("smslib.serial.polling") != null) this.PARALLEL_POLLING = true;
		if (System.getProperty("smslib.serial.pollinginterval") != null) this.SERIAL_POLLING_INTERVAL = Integer.parseInt(System.getProperty("smslib.serial.pollinginterval"));
                if (System.getProperty("smslib.serial.pollinginterval") != null) this.PARALLEL_POLLING_INTERVAL = Integer.parseInt(System.getProperty("smslib.serial.pollinginterval"));
		if (System.getProperty("smslib.serial.timeout") != null) this.SERIAL_TIMEOUT = Integer.parseInt(System.getProperty("smslib.serial.timeout"));
                if (System.getProperty("smslib.serial.timeout") != null) this.PARALLEL_TIMEOUT = Integer.parseInt(System.getProperty("smslib.serial.timeout"));
		if (System.getProperty("smslib.serial.keepalive") != null) this.SERIAL_KEEPALIVE_INTERVAL = Integer.parseInt(System.getProperty("smslib.serial.keepalive"));
                if (System.getProperty("smslib.serial.keepalive") != null) this.PARALLEL_KEEPALIVE_INTERVAL = Integer.parseInt(System.getProperty("smslib.serial.keepalive"));
                if (System.getProperty("smslib.serial.keepalive") != null) this.SERIAL_KEEPALIVE_INTERVAL = Integer.parseInt(System.getProperty("smslib.serial.keepalive"));
                if (System.getProperty("smslib.serial.keepalive") != null) this.PARALLEL_KEEPALIVE_INTERVAL = Integer.parseInt(System.getProperty("smslib.serial.keepalive"));
		if (System.getProperty("smslib.serial.buffer") != null) this.SERIAL_BUFFER_SIZE = Integer.parseInt(System.getProperty("smslib.serial.buffer"));
                if (System.getProperty("smslib.serial.buffer") != null) this.PARALLEL_BUFFER_SIZE = Integer.parseInt(System.getProperty("smslib.serial.buffer"));
		if (System.getProperty("smslib.serial.clearwait") != null) this.SERIAL_CLEAR_WAIT = Integer.parseInt(System.getProperty("smslib.serial.clearwait"));
                if (System.getProperty("smslib.serial.clearwait") != null) this.PARALLEL_CLEAR_WAIT = Integer.parseInt(System.getProperty("smslib.serial.clearwait"));
