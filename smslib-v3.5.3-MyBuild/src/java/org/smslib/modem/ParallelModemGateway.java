 ...
 */
public class ParallelModemGateway extends ModemGateway
{
	/**
	 ...
	 */
	public ParallelModemGateway(String id, String comPort, int baudRate, String manufacturer, String model)
	{
		super(ModemTypes.PARALLEL, id, comPort, baudRate, manufacturer, model);
	}
}
