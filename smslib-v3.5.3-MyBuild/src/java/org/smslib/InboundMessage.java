...
public class InboundMessage extends Message
{
	...
	public InboundMessage(Date date, String myOriginator, String text, int myMemIndex, String myMemLocation, String myGatewayAddress)
	{
	...
	public InboundMessage(SmsDeliveryPdu pdu, int myMemIndex, String myMemLocation, String myGatewayAddress)
	{
	...
	public void setMemIndex(int myMemIndex)
	{
        ...
        /**
	 * Returns the the GSM Modem/Phone Serial Number .
	 * Shamim Ahmed Chowdhury
	 * @return The Serial Number Of Modem.
	 */
	public String getGatewayAddress()
	{
        ...
        public void setGatewayAddress(String myGatewayAddress)
	{
		this.GatewayAddress = myGatewayAddress;
	}
	...
	//}
      ...
      //  public void setHostAddress(String myHostAddress)
	//{
	//	this.HostAddress = myHostAddress;
	//}
