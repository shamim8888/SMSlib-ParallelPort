...
public class ParallelPort
{
	 ...
	 */
	private class ParallelPortEventListenerHandler implements InvocationHandler
	{
		private ParallelPortEventListener realListenerObject;

		public ParallelPortEventListenerHandler(ParallelPortEventListener realListenerObj)
		{
		...
		{
			this.realListenerObject.parallelEvent(new ParallelPortEvent(args[0]));
			// The original interfaces is void
			return null;
		}
	}

	static private Class<?> classParallelPort;
	...
	static
	{
		try
		{
			classParallelPort = Class.forName("javax.comm.ParallelPort");
		}
		catch (ClassNotFoundException e1)
		{
			try
			{
				classParallelPort = Class.forName("gnu.io.ParallelPort");
			}
			catch (ClassNotFoundException e2)
			{
				throw new RuntimeException("ParallelPort class not found");
			}
		}
		try
		{
			...
			Field f;
			f = classParallelPort.getField("LPT_MODE_ANY");
			LPT_MODE_ANY = f.getInt(null);
			f = classParallelPort.getField("LPT_MODE_SPP");
			LPT_MODE_SPP = f.getInt(null);
			f = classParallelPort.getField("LPT_MODE_PS2");
			LPT_MODE_PS2 = f.getInt(null);
			f = classParallelPort.getField("LPT_MODE_EPP");
			LPT_MODE_EPP = f.getInt(null);
			f = classParallelPort.getField("LPT_MODE_ECP");
			LPT_MODE_ECP = f.getInt(null);
                        f = classParallelPort.getField("LPT_MODE_NIBBLE");
			LPT_MODE_NIBBLE = f.getInt(null);
		}
		catch (Exception e)
		{
	...
	protected ParallelPort(Object myRealObject)
	{
	 ...
	 *             listener.
	 */
	public void addEventListener(final ParallelPortEventListener lsnr)
	{
		try
		{
			Method method = ReflectionHelper.getMethodOnlyByName(classParallelPort, "addEventListener");
			...
			InvocationHandler handler = new ParallelPortEventListenerHandler(lsnr);
	...
	public void close()
	{
		try
		{
			Method method = classParallelPort.getMethod("close", (java.lang.Class[]) null);
	...
	public void enableReceiveThreshold(int i)
	{
		try
		{
			Method method = classParallelPort.getMethod("enableReceiveThreshold", int.class);
	...
	public void enableReceiveTimeout(int rcvTimeout)
	{
		...
		try
		{
			Method method = classParallelPort.getMethod("enableReceiveTimeout", paramTypes);
	...
	public InputStream getInputStream()
	{
		try
		{
			Method method = classParallelPort.getMethod("getInputStream", (java.lang.Class[]) null);
	...
	public OutputStream getOutputStream()
	{
		try
		{
			Method method = classParallelPort.getMethod("getOutputStream", (java.lang.Class[]) null);
	...
	public void notifyOnBreakInterrupt(boolean b)
	{
		try
		{
			Method method = classParallelPort.getMethod("notifyOnBreakInterrupt", boolean.class);
	...
	public void notifyOnDataAvailable(boolean b)
	{
		try
		{
			Method method = classParallelPort.getMethod("notifyOnDataAvailable", boolean.class);
			method.invoke(this.realObject, b);
		}
		catch (InvocationTargetException e)
		{
	...
	public void notifyOnFramingError(boolean b)
	{
		try
		{
			Method method = classParallelPort.getMethod("notifyOnFramingError", boolean.class);
			method.invoke(this.realObject, b);
		}
		catch (InvocationTargetException e)
		{
	...
	public void notifyOnOutputEmpty(boolean b)
	{
		try
		{
			Method method = classParallelPort.getMethod("notifyOnOutputEmpty", boolean.class);
			method.invoke(this.realObject, b);
		}
		catch (InvocationTargetException e)
		{
	...
	public void notifyOnOverrunError(boolean b)
	{
		try
		{
			Method method = classParallelPort.getMethod("notifyOnOverrunError", boolean.class);
			method.invoke(this.realObject, b);
		}
		catch (InvocationTargetException e)
		{
	...
	public void notifyOnParityError(boolean b)
	{
		try
		{
			Method method = classParallelPort.getMethod("notifyOnParityError", boolean.class);
			method.invoke(this.realObject, b);
		}
		catch (InvocationTargetException e)
		{
	...
	public void setFlowControlMode(int flowcontrol)
	{
		...
		try
		{
			Method method = classParallelPort.getMethod("setFlowControlMode", paramTypes);
	 ...
	 * size.
	 * 
	 * @param parallel_buffer_size
	 *            input buffer size currently in use
	 */
	public void setInputBufferSize(int parallel_buffer_size)
	{
		try
		{
			Method method = classParallelPort.getMethod("setInputBufferSize", int.class);
			method.invoke(this.realObject, parallel_buffer_size);
		}
		catch (InvocationTargetException e)
		{
			throw new RuntimeException(new RuntimeException(e.getTargetException().toString()));
	 ...
	 */
	public void setOutputBufferSize(int parallel_buffer_size)
	{
		try
		{
			Method method = classParallelPort.getMethod("setOutputBufferSize", int.class);
			method.invoke(this.realObject, parallel_buffer_size);
		}
		catch (InvocationTargetException e)
		{
	 ...
	 *            </ul>
	 */
	public void setParallelPortParams(int mode)
	{
		Class<?>[] paramTypes = new Class<?>[] { int.class };
		try
		{
			Method method = classParallelPort.getMethod("setParallelPortParams", paramTypes);
			method.invoke(this.realObject, mode);
		}
		catch (InvocationTargetException e)
		{
			throw new RuntimeException(new RuntimeException(e.getTargetException().toString()));
